...
int main(int argc, char *argv[])
{
    ...
    window = SDL_CreateWindow("Manhattan Groupe 3", 100, 100, WIDTH_WINDOW, HEIGHT_WINDOW, SDL_WINDOW_OPENGL);
...
void writeInFile(int nodesOpen, int nodesClose,struct timeval startTime, struct timeval endTime){
    ...
    file = fopen("Manhattan.txt", "a+");
    fprintf(file, "--------------Distance Manhattan------------------------------\n");
